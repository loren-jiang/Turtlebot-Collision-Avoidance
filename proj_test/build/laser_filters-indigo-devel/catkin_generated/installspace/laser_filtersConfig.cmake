...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106b/sp18/class/ee106b-aac/ros_workspaces/proj_test/install/${idir}'.  Ask the maintainer 'Jon Binney <jon.binney@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106b/sp18/class/ee106b-aac/ros_workspaces/proj_test/install/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
